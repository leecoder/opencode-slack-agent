...
async function callBackgroundOutput(bgTaskID: string): Promise<{ ok: boolean; statusCode: number; payload?: unknown; error?: string; unsupported?: boolean; retryable?: boolean }> {
